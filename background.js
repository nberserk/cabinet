...
chrome.tabs.onRemoved.addListener(async (tabId, removeInfo) => {
    try {
        ...
        // Send specific TAB_REMOVED message for incremental update
        try {
            ...
            console.log('📤 TAB_REMOVED message failed, using fallback');
        }
...
chrome.tabs.onActivated.addListener(async (activeInfo) => {
    try {
        ...
        if (newActive) {
            ...
            // Send specific TAB_ACTIVATED message for incremental update
            try {
                chrome.runtime.sendMessage({
                    type: 'TAB_ACTIVATED',
                    ...
                    console.log('📤 TAB_ACTIVATED message sent (no receivers)');
                });
            } catch (msgError) {
                console.log('📤 TAB_ACTIVATED message failed, using fallback');
            }
