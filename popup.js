...
async function init() {
  try {
    ...
    currentWindowId = currentTab[0]?.windowId;
    
    // Get tabs only from current window
    ...
    console.log('Initial tabs:', Object.keys(allTabs).length);
    console.log('Initial tree:', Object.keys(tabTree).length);
